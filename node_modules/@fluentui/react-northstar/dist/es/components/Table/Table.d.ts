...
import { WithAsProp, ShorthandCollection, ShorthandValue, FluentComponentStaticProps } from '../../types';
...
export declare const Table: React.FC<WithAsProp<TableProps>> & FluentComponentStaticProps<TableProps> & {
...
declare const _default: {
    ...
    displayName: string;
    handledProps: ("header" | "children" | "className" | "variables" | "styles" | "accessibility" | "design" | "rows" | "compact")[];
    create: import("../../utils").ShorthandFactory<TableProps>;
    shorthandConfig: import("../../utils").ShorthandConfig<TableProps>;
    Cell: {
        <Tag_1>(x: {
            as: Tag_1;
        ...
        shorthandConfig: import("../../utils").ShorthandConfig<import("./TableCell").TableCellProps>;
    };
    Row: {
        <Tag_2>(x: {
            as: Tag_2;
        ...
        (x: {
            accessibility?: Accessibility<import("@fluentui/accessibility").GridRowBehaviorProps>;
            items?: ShorthandCollection<import("./TableCell").TableCellProps, never>;
            header?: boolean;
            compact?: boolean;
            selected?: boolean;
            onClick?: import("../../types").ComponentEventHandler<TableRowProps>;
            className?: string;
            design?: import("@fluentui/react-bindings").ComponentDesignProp;
            styles?: import("@fluentui/styles").ComponentSlotStyle<any, any>;
            variables?: any;
        ...
        displayName: string;
        handledProps: ("header" | "className" | "onClick" | "variables" | "styles" | "selected" | "accessibility" | "design" | "items" | "compact")[];
        create: import("../../utils").ShorthandFactory<TableRowProps>;
        shorthandConfig: import("../../utils").ShorthandConfig<TableRowProps>;
    };
};
/**
