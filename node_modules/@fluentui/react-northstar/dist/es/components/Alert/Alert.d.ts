...
import { ComponentEventHandler, WithAsProp, ShorthandValue, ShorthandCollection, FluentComponentStaticProps } from '../../types';
...
export declare const Alert: React.FC<WithAsProp<AlertProps>> & FluentComponentStaticProps<AlertProps> & {
...
declare const _default: {
    ...
    displayName: string;
    handledProps: ("visible" | "content" | "icon" | "body" | "header" | "className" | "onFocus" | "variables" | "styles" | "accessibility" | "design" | "success" | "danger" | "warning" | "info" | "attached" | "fitted" | "dismissible" | "actions" | "defaultVisible" | "dismissAction" | "onVisibleChange")[];
    create: import("../../utils").ShorthandFactory<AlertProps>;
    shorthandConfig: import("../../utils").ShorthandConfig<AlertProps>;
    DismissAction: {
        <Tag_1>(x: {
            as: Tag_1;
        ...
        shorthandConfig: import("../../utils").ShorthandConfig<AlertDismissActionProps>;
    };
};
/**
