...
import { WithAsProp, ComponentEventHandler, FluentComponentStaticProps } from '../../types';
...
export declare const AccordionContent: React.FC<WithAsProp<AccordionContentProps>> & FluentComponentStaticProps<AccordionContentProps>;
