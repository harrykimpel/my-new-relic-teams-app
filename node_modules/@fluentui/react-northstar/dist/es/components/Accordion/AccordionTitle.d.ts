...
import { WithAsProp, ComponentEventHandler, ShorthandValue, FluentComponentStaticProps } from '../../types';
...
export declare const AccordionTitle: React.FC<WithAsProp<AccordionTitleProps>> & FluentComponentStaticProps<AccordionTitleProps>;
