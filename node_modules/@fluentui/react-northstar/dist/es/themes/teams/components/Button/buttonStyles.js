...
var buttonStyles = {
  ...
  loader: function loader(_ref3) {
    ...
    var p = _ref3.props,
        v = _ref3.variables;
    return Object.assign((_Object$assign = {}, _defineProperty(_Object$assign, "& .".concat(loaderSlotClassNames.indicator), {
      width: p.size === 'small' ? v.sizeSmallLoaderSize : v.loaderSize,
      height: p.size === 'small' ? v.sizeSmallLoaderSize : v.loaderSize
    }), _defineProperty(_Object$assign, "& .".concat(loaderSlotClassNames.svg), {
      ':before': {
        animationName: {
          to: {
