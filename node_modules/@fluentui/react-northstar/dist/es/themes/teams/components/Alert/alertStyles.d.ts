...
export declare const getIntentColorsFromProps: (p: AlertDismissActionStylesProps, v: AlertVariables, siteVars: SiteVariablesPrepared) => ICSSInJSStyle;
declare const alertStyles: ComponentSlotStylesPrepared<AlertStylesProps, AlertVariables>;
