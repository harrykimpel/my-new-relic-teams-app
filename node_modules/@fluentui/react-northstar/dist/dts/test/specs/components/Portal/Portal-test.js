...
describe('Portal', function () {
    var testPortalInnerIsOpen = function (rootWrapper, visible) {
        expect(rootWrapper.find(PortalInner_1.default).length).toBe(visible ? 1 : 0);
    };
    ...
    it('translates open prop to state', function () {
        ...
        var wrapper = utils_1.mountWithProvider(React.createElement(Portal_1.default, { content: React.createElement("p", null) }));
        testPortalOpenState(wrapper, content, false);
        var openPortalWrapper = utils_1.mountWithProvider(React.createElement(Portal_1.default, { content: React.createElement("p", null), open: true }));
        testPortalOpenState(openPortalWrapper, content, true);
    });
    describe('click', function () {
        it('opens the portal on trigger click when true', function () {
            var wrapper = utils_1.mountWithProvider(React.createElement(Portal_1.default, { content: React.createElement("p", null), trigger: React.createElement("button", null, "button") }));
        ...
        it('closes the portal on click when set', function () {
            var wrapper = utils_1.mountWithProvider(React.createElement(Portal_1.default, { content: React.createElement("p", null), defaultOpen: true, trigger: React.createElement("button", null, "button") }));
            testPortalInnerIsOpen(wrapper, true);
            wrapper.find('button').simulate('click');
            testPortalInnerIsOpen(wrapper, false);
        });
    ...
    describe('document click', function () {
        it('closes the portal', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        wrapper = utils_1.mountWithProvider(React.createElement(Portal_1.default, { content: React.createElement("p", null), defaultOpen: true }));
                        testPortalInnerIsOpen(wrapper, true);
        ...
        it('does not close on click inside', function () {
            var wrapper = utils_1.mountWithProvider(React.createElement(Portal_1.default, { content: React.createElement("p", { id: "inner" }), defaultOpen: true }));
            testPortalInnerIsOpen(wrapper, true);
    ...
    describe('onMount', function () {
        it('called when portal opens', function () {
            var onMount = jest.fn();
            var wrapper = utils_1.mountWithProvider(React.createElement(Portal_1.default, { content: React.createElement("p", null), onMount: onMount }));
    ...
    describe('onUnmount', function () {
        it('is called when portal closes', function () {
            ...
            var wrapper = utils_1.mountWithProvider(React.createElement(Portal_1.default, { content: React.createElement("p", null), onUnmount: onUnmount, open: true }));
    ...
    describe('triggerRef', function () {
        it('maintains ref on the trigger', function () {
            ...
            var wrapper = utils_1.mountWithProvider(React.createElement(Portal_1.default, { content: React.createElement("p", null), trigger: React.createElement("button", { id: "trigger" }), triggerRef: triggerRef }), {
                attachTo: mountNode,
            });
    ...
    describe('trigger', function () {
        ...
        it('renders the trigger when set', function () {
            ...
            var wrapper = utils_1.mountWithProvider(React.createElement(Portal_1.default, { content: React.createElement("p", null), trigger: React.createElement("button", null, text) }));
