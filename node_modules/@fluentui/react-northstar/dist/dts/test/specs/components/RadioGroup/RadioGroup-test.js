...
var radioGroupImplementsCollectionShorthandProp = implementsCollectionShorthandProp_1.default(RadioGroup_1.default);
...
describe('RadioGroup', function () {
    commonTests_1.isConformant(RadioGroup_1.default, { autoControlledProps: ['checkedValue'] });
    describe('accessibility', function () {
        commonTests_1.handlesAccessibility(RadioGroup_1.default, {
        ...
        test('compliance', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () { return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, commonTests_1.htmlIsAccessibilityCompliant(React.createElement(RadioGroup_1.default, { items: getShorthandItems() }))];
                case 1: return [2 /*return*/, _a.sent()];
            }
        }); }); });
    });
    describe('implementsCollectionShorthandProp', function () {
        radioGroupImplementsCollectionShorthandProp('items', RadioGroupItem_1.default, {
    ...
    var itemsTest = function (getItems, isShorthandApiTest) {
        ...
        it('renders children', function () {
            var items = utils_1.mountWithProvider(React.createElement(RadioGroup_1.default, { items: getItems() })).find('RadioGroupItem');
        ...
        it('calls onClick handler for item', function () {
            var items = getItems();
            var radioGroupItems = utils_1.mountWithProvider(React.createElement(RadioGroup_1.default, { items: items })).find('RadioGroupItem');
            radioGroupItems
                .first()
                .find('div')
                .first()
        ...
        it('passes arbitrary props', function () {
            var radioGroupItems = utils_1.mountWithProvider(React.createElement(RadioGroup_1.default, { items: getItems() })).find('RadioGroupItem');
        ...
        if (isShorthandApiTest) {
            describe('click event handler', function () {
                it('should set "checked" when item is clicked', function () {
                    ...
                    var wrapper = utils_1.mountWithProvider(React.createElement(RadioGroup_1.default, { items: getItems(), onCheckedValueChange: onCheckedValueChange }));
        ...
        it('should not call checkedValueChanged when index did not change', function () {
            var onCheckedValueChange = jest.fn();
            var wrapper = utils_1.mountWithProvider(React.createElement(RadioGroup_1.default, { items: getItems(), onCheckedValueChange: onCheckedValueChange, checkedValue: "test-value2" }));
            var radioGroupItems = wrapper.find('RadioGroupItem');
            radioGroupItems
                .at(1)
                .find('div')
        ...
        if (isShorthandApiTest) {
            it('should not set "checked" when disabled item is clicked', function () {
                var wrapper = utils_1.mountWithProvider(React.createElement(RadioGroup_1.default, { items: getItems({ disabledItem: 1 }) }));
                var radioGroupItems = wrapper.find('RadioGroupItem');
                radioGroupItems
                    .at(1)
                    .find('div')
        ...
        describe('keyDown event handler', function () {
            var testKeyDown = function (testName, items, initialValue, keyCode, expectedValue) {
                it("keyDown test - " + testName, function () {
                    var onCheckedValueChange = jest.fn();
                    var wrapper = utils_1.mountWithProvider(React.createElement(RadioGroup_1.default, { items: items, checkedValue: initialValue, onCheckedValueChange: onCheckedValueChange }));
                    wrapper
                        .find('div')
                        .first()
