...
describe('MenuItem', function () {
    commonTests_1.isConformant(MenuItem_1.default, {
        eventTargets: {
            onClick: '.ui-menu__item__wrapper',
        },
        wrapperComponent: Box_1.default,
        autoControlledProps: ['menuOpen'],
    });
    commonTests_1.implementsShorthandProp(MenuItem_1.default)('menu', Menu_1.default, {
        implementsPopper: true,
        requiredProps: { active: true, menuOpen: true },
    });
    it('content renders as `li > a`', function () {
        var menuItem = utils_1.mountWithProviderAndGetComponent(MenuItem_1.default, React.createElement(MenuItem_1.default, { content: "Home" }))
    ...
    it('children render directly inside `li`', function () {
        var menuItem = utils_1.mountWithProviderAndGetComponent(MenuItem_1.default, React.createElement(MenuItem_1.default, null, "Home"))
            .find('.ui-menu__item__wrapper')
            .hostNodes();
        expect(menuItem.is('li')).toBe(true);
    ...
    describe('accessibility', function () {
        commonTests_1.handlesAccessibility(MenuItem_1.default, { defaultRootRole: 'presentation', usesWrapperSlot: true });
        commonTests_1.handlesAccessibility(MenuItem_1.default, { defaultRootRole: 'menuitem', partSelector: 'a' });
        var behaviors = [
        ...
        behaviors.forEach(function (accessibility) {
            test("integration test for " + accessibility.name + " behavior", function () {
                ...
                var menuItemComponent = utils_1.mountWithProviderAndGetComponent(MenuItem_1.default, React.createElement(MenuItem_1.default, { disabled: true, "aria-label": ariaLabel, accessibility: accessibility.behavior }));
