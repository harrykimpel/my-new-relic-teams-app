...
var listImplementsCollectionShorthandProp = implementsCollectionShorthandProp_1.default(List_1.default);
describe('List', function () {
    commonTests_1.isConformant(List_1.default, {
        constructorName: 'List',
    });
    commonTests_1.handlesAccessibility(List_1.default, { defaultRootRole: 'list' });
    listImplementsCollectionShorthandProp('items', ListItem_1.default, { mapsValueToProp: 'content' });
    ...
    describe('items', function () {
        it('renders children', function () {
            var listItems = utils_1.mountWithProvider(React.createElement(List_1.default, { items: getItems() })).find('ListItem');
        ...
        it('calls onClick handler for item', function () {
            var onClick = jest.fn();
            var listItems = utils_1.mountWithProvider(React.createElement(List_1.default, { items: getItems(onClick) })).find('ListItem');
            listItems
                .first()
                .find('li')
                .first()
    ...
    describe('selectedIndex', function () {
        it('should not be set by default', function () {
            var wrapper = utils_1.mountWithProvider(React.createElement(List_1.default, { selectable: true, items: getItems() }));
        ...
        it('can be set a default value', function () {
            var wrapper = utils_1.mountWithProvider(React.createElement(List_1.default, { selectable: true, defaultSelectedIndex: 0, items: getItems() }));
            expect(wrapper
                .find('li')
                .at(0)
        ...
        it('calls onClick handler for item if `selectable`', function () {
            ...
            var listItems = utils_1.mountWithProvider(React.createElement(List_1.default, { items: getItems(onClick), onSelectedIndexChange: onSelectedIndexChange, selectable: true })).find('ListItem');
            listItems
                .first()
                .find('li')
                .first()
