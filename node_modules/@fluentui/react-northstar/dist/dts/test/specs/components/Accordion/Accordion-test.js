...
describe('Accordion', function () {
    commonTests_1.isConformant(Accordion_1.default, { constructorName: 'Accordion', autoControlledProps: ['activeIndex'] });
    describe('activeIndex', function () {
        ...
        it('actives the indexes clicked by the user if the panels were closed', function () {
            var accordion = utils_1.mountWithProvider(React.createElement(Accordion_1.default, { panels: panels }));
        ...
        it('actives the only one index clicked by the user if exclusive prop is passed', function () {
            var accordion = utils_1.mountWithProvider(React.createElement(Accordion_1.default, { panels: panels, exclusive: true }));
            getTitleButtonAtIndex(accordion, 0).simulate('click');
            expect(accordion
                .find('AccordionTitle')
        ...
        it('deactivate indexes removed when their panels are closed by the user', function () {
            var accordion = utils_1.mountWithProvider(React.createElement(Accordion_1.default, { panels: panels, defaultActiveIndex: [0, 1, 2] }));
            getTitleButtonAtIndex(accordion, 0).simulate('click');
            getTitleButtonAtIndex(accordion, 2).simulate('click');
        ...
        it('keeps the at least one panel open if expanded prop is passed', function () {
            var accordion = utils_1.mountWithProvider(React.createElement(Accordion_1.default, { panels: panels, defaultActiveIndex: [0], expanded: true }));
            getTitleButtonAtIndex(accordion, 0).simulate('click');
