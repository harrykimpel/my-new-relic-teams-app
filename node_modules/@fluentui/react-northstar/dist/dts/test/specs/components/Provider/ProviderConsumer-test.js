...
describe('ProviderConsumer', function () {
    test('is exported', function () {
        expect(require('src/index.ts').ProviderConsumer).toEqual(ProviderConsumer_1.default);
    });
    test('is a subcomponent of the Provider', function () {
        expect(Provider_1.default.Consumer).toEqual(ProviderConsumer_1.default);
    });
    describe('render', function () {
        test('is a callback that receives the prepared theme', function () {
            ...
            enzyme_1.mount(React.createElement(Provider_1.default, { theme: inputTheme },
                React.createElement(Provider_1.default.Consumer, { render: function (preparedTheme) {
                        // siteVariables
