...
describe('ToolbarRadioGroup', function () {
    commonTests_1.isConformant(ToolbarRadioGroup_1.default, {
        constructorName: 'ToolbarRadioGroup',
    });
    describe('accessibility', function () {
        commonTests_1.handlesAccessibility(ToolbarRadioGroup_1.default, {
    ...
    describe('allows cycling between items using UP/DOWN arrow keys', function () {
        ...
        var testKeyDown = function (testName, items, keyCode, expectedFocusedIndex) {
            it("keyDown test - " + testName, function () {
                var radioButtons = utils_1.mountWithProvider(React.createElement(ToolbarRadioGroup_1.default, { items: items })).find('button');
