...
function createShorthand(Component, value, options) {
    var _a = Component.shorthandConfig || {}, _b = _a.mappedProp, mappedProp = _b === void 0 ? 'children' : _b, _c = _a.allowsJSX, allowsJSX = _c === void 0 ? true : _c, mappedArrayProp = _a.mappedArrayProp;
    return createShorthandInternal({
        Component: Component,
        mappedProp: mappedProp,
        allowsJSX: allowsJSX,
