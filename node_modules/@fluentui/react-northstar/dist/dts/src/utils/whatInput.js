...
if (isBrowser_1.default() && 'addEventListener' in window && Array.prototype.indexOf) {
    setUp();
}
/*
 * set up for document
...
exports.setUpWhatInput = function (target) {
    ...
    if (isBrowser_1.default() && targetWindow && 'addEventListener' in targetWindow && Array.prototype.indexOf) {
...
exports.tryCleanupWhatInput = function (target) {
    var targetWindow = target.defaultView;
    if (isBrowser_1.default() && targetWindow && 'removeEventListener' in targetWindow) {
