...
declare const createComponent: <P extends ObjectOf<any> = any>({ displayName, className, render, defaultProps, actionHandlers, }: CreateComponentConfig<P>) => CreateComponentReturnType<P>;
