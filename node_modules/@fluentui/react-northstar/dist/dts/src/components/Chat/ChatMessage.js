...
var ChatMessage = function (props) {
    ...
    var renderActionMenu = function () {
        ...
        return (React.createElement(positioner_1.Popper, tslib_1.__assign({ enabled: positionActionMenu, align: "end", modifiers: modifiers, position: "above", positionFixed: overflow, targetRef: messageNode }, positioner_1.getPopperPropsFromShorthand(actionMenu)), function (_a) {
