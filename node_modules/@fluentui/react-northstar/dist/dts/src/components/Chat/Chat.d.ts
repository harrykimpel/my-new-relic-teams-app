...
declare const _default: {
    ...
    shorthandConfig: import("../../utils").ShorthandConfig<ChatProps>;
    Item: {
        <Tag_1>(x: {
            as: Tag_1;
        } & ChatItemProps & {
        ...
        shorthandConfig: import("../../utils").ShorthandConfig<ChatItemProps>;
    };
    Message: {
        <Tag_2>(x: {
            as: Tag_2;
        ...
        (x: {
            accessibility?: Accessibility<never>;
            actionMenu?: string | number | boolean | React.ReactElement<any, string | ((props: any) => React.ReactElement<any, string | any | (new (props: any) => React.Component<any, any, any>)>) | (new (props: any) => React.Component<any, any, any>)> | React.ReactNodeArray | React.ReactPortal | import("../../types").ObjectShorthandValue<import("../..").MenuProps & {
        ...
        shorthandConfig: import("../../utils").ShorthandConfig<import("./ChatMessage").ChatMessageProps>;
    };
};
/**
