...
exports.Table = function (props) {
        ...
        return _.map(rows, function (row, index) {
            ...
            return TableRow_1.default.create(row, {
                defaultProps: function () {
                    return getA11yProps('row', tslib_1.__assign({}, props));
                },
    ...
    var renderHeader = function () {
        ...
        return TableRow_1.default.create(header, {
            defaultProps: function () {
                return getA11yProps('row', tslib_1.__assign({}, headerRowProps));
            },
            overrideProps: overrideProps,
        });
    };
 ...
 */
exports.default = types_1.withSafeTypeForAs(exports.Table);
