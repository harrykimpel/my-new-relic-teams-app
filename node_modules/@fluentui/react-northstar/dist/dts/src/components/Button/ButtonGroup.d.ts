...
import { WithAsProp, ShorthandCollection, FluentComponentStaticProps } from '../../types';
...
export declare type ButtonGroupStylesProps = Required<Pick<ButtonGroupProps, 'circular'>>;
export declare const buttonGroupClassName = "ui-buttons";
export declare const ButtonGroup: React.FC<WithAsProp<ButtonGroupProps>> & FluentComponentStaticProps<ButtonGroupProps>;
declare const _default: {
    ...
    displayName: string;
    handledProps: ("content" | "children" | "className" | "variables" | "styles" | "accessibility" | "design" | "circular" | "buttons")[];
    create: import("../../utils").ShorthandFactory<ButtonGroupProps>;
    shorthandConfig: import("../../utils").ShorthandConfig<ButtonGroupProps>;
};
/**
