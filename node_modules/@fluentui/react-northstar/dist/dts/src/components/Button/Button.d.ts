...
import { UIComponentProps, ContentComponentProps, ChildrenComponentProps, SizeValue, ShorthandFactory, ShorthandConfig } from '../../utils';
...
declare const Button: ComponentWithAs<"button", ButtonProps> & {
    ...
    Content: ComponentWithAs<"span", ButtonContentProps> & {
        shorthandConfig: ShorthandConfig<ButtonContentProps>;
    };
    Group: {
        <Tag>(x: {
            as: Tag;
        ...
        shorthandConfig: ShorthandConfig<import("./ButtonGroup").ButtonGroupProps>;
    };
};
