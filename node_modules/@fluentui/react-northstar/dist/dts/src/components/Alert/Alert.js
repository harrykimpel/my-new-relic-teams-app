...
exports.Alert = function (props) {
    ...
    var element = (React.createElement(ElementType, tslib_1.__assign({}, getA11yProps('root', tslib_1.__assign({ className: classes.root, onFocus: handleFocus }, unhandledProps))), utils_1.childrenExist(children) ? children : renderContent()));
    setEnd();
    return element;
};
...
exports.Alert.DismissAction = AlertDismissAction_1.default;
/**
 ...
 */
exports.default = types_1.withSafeTypeForAs(exports.Alert);
