 ...
 */
var AttachmentAction = react_bindings_1.compose(Button_1.default, {
...
AttachmentAction.propTypes = tslib_1.__assign(tslib_1.__assign({}, utils_1.commonPropTypes.createCommon({
    content: 'shorthand',
...
exports.default = AttachmentAction;
