...
export declare const toolbarMenuRadioGroupClassName = "ui-toolbars";
export declare const toolbarMenuRadioGroupSlotClassNames: ToolbarMenuRadioGroupSlotClassNames;
declare const _default: {
    ...
    shorthandConfig: import("../../utils").ShorthandConfig<ToolbarMenuRadioGroupProps>;
};
/**
