...
export declare const DialogFooter: React.FC<WithAsProp<DialogFooterProps>> & FluentComponentStaticProps<DialogFooterProps>;
declare const _default: {
    ...
    shorthandConfig: import("../../utils").ShorthandConfig<DialogFooterProps>;
};
/**
