...
exports.Accordion = function (props) {
    ...
    var itemRefs = React.useMemo(function () { var _a; return Array.from({ length: (_a = panels) === null || _a === void 0 ? void 0 : _a.length }, function () { return React.createRef(); }); }, [(_a = panels) === null || _a === void 0 ? void 0 : _a.length]);
    ...
    var renderPanels = function () {
        ...
        _.each(panels, function (panel, index) {
            ...
            children.push(utils_1.createShorthand(AccordionTitle_1.default, title, {
            ...
            children.push(utils_1.createShorthand(AccordionContent_1.default, content, {
                defaultProps: function () { return ({
...
exports.Accordion.Title = AccordionTitle_1.default;
 ...
 */
exports.default = types_1.withSafeTypeForAs(exports.Accordion);
