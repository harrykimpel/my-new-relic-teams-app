    ...
    return (React.createElement(React.Fragment, null,
        ...
        data.map(function (theme, idx) {
            ...
            return (React.createElement("pre", { key: idx, style: {
                ...
                React.createElement(DebugPanelData_1.default, { data: filteredTheme, comments: comments[idx], commentKeyPredicate: commentKeyPredicate, overrides: mergedThemes[idx], highlightKey: value })));
        })));
};
exports.default = DebugPanelItem;
