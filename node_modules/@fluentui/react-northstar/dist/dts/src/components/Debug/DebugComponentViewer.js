...
var DebugComponentViewer = function (props) {
    ...
    var component = fiberNav.name && React.createElement(DebugLine_1.default, null, fiberNav.jsxString);
    return (React.createElement(ScrollToBottom_1.default, { style: style },
        React.createElement(DebugLine_1.default, tslib_1.__assign({ indent: 0 }, (ownerNav.fluentUIDebug && {
            actionable: true,
            tabIndex: 0,
            onClick: function (e) {
                e.preventDefault();
        ...
        React.createElement(DebugLine_1.default, { indent: 1, style: { color: '#ba645e' } }, "render()"),
        parentNavs.map(function (parent, i) { return (React.createElement(DebugLine_1.default, { key: i, indent: 2 + i, actionable: true, tabIndex: "0", onClick: function (e) {
                e.preventDefault();
        ...
        React.createElement(DebugLine_1.default, { indent: 3 + (parentNavs.length - 1), active: true, badge: "selected", actionable: true, tabIndex: "0", onClick: function (e) {
                e.preventDefault();
...
exports.default = DebugComponentViewer;
