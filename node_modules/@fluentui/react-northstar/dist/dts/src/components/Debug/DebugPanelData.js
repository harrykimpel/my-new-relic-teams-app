            ...
            return (React.createElement("div", { key: key },
                React.createElement("span", { style: { background: highlight ? 'rgb(255,255,224)' : '' } },
                    ...
                    React.createElement("span", { style: { textDecoration: overridden ? 'line-through' : 'none' } },
                        ...
                        ': ',
                        React.createElement(DebugPanelData, { data: value, comments: comment, commentKeyPredicate: commentKeyPredicate, indent: indent + 2, overrides: overrides ? overrides[key] : null, highlightKey: highlightKey })),
                    ',')));
        }), (indent > 2 ? ' '.repeat(indent - 2) : '') + "}"));
};
exports.default = DebugPanelData;
