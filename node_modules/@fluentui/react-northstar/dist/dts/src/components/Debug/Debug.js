...
var Debug = /** @class */ (function (_super) {
    ...
    function Debug(p, s) {
        ...
        _this.debugReactComponent = function (r) {
            ...
            var fiberNav = FiberNavigator_1.default.fromFiber(r._reactInternalFiber);
            _this.setState({ fiberNav: fiberNav, isSelecting: false, selectedFiberNav: null });
        };
        _this.debugDOMNode = function (domNode) {
            var fiberNav = FiberNavigator_1.default.fromDOMNode(domNode);
            if (!fiberNav) {
        ...
        _this.handleKeyDown = function (e) {
            var code = keyboard_key_1.default.getCode(e);
            switch (code) {
                case keyboard_key_1.default.Escape:
                    _this.stopSelecting();
                    break;
                case keyboard_key_1.default.d:
    ...
    Debug.prototype.render = function () {
        ...
        if (process.env.NODE_ENV !== 'production' && styles_1.isDebugEnabled) {
            return (React.createElement(React.Fragment, null,
                ...
                isSelecting && fiberNav && React.createElement(DebugRect_1.default, { fiberNav: fiberNav }),
                selectedFiberNav && React.createElement(DebugRect_1.default, { fiberNav: selectedFiberNav }),
                !isSelecting && fiberNav && fiberNav.instance && (React.createElement(DebugPanel_1.default, { fiberNav: fiberNav, onActivateDebugSelectorClick: this.startSelecting, onClose: this.close, 
