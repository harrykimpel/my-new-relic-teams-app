...
exports.Embed = function (props) {
    ...
    var placeholderElement = placeholder ? (React.createElement(Image_1.default, { src: placeholder, styles: resolvedStyles.image, variables: { width: variables.width, height: variables.height } })) : null;
    ...
    var element = (React.createElement(ElementType, tslib_1.__assign({}, getA11yProps('root', tslib_1.__assign({ className: classes.root, onClick: handleClick }, unhandledProps))),
        active && (React.createElement(React.Fragment, null,
            ...
            iframe && (React.createElement(react_component_ref_1.Ref, { innerRef: frameRef }, Box_1.default.create(iframe, {
                defaultProps: function () {
 ...
 */
exports.default = types_1.withSafeTypeForAs(exports.Embed);
