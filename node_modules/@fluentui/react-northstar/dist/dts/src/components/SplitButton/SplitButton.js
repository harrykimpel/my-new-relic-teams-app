...
exports.SplitButton = function (props) {
    ...
    setStart();
    var button = props.button, disabled = props.disabled, menu = props.menu, primary = props.primary, secondary = props.secondary, toggleButton = props.toggleButton, size = props.size, position = props.position, align = props.align, flipBoundary = props.flipBoundary, overflowBoundary = props.overflowBoundary, positionFixed = props.positionFixed, offset = props.offset, unstable_pinned = props.unstable_pinned, className = props.className, design = props.design, styles = props.styles, accessibility = props.accessibility, variables = props.variables;
            ...
            MenuButton_1.default.create({}, {
                defaultProps: function () {
                    return getA11yProps('menuButton', {
                        ...
                        on: [],
                        open: open,
                        trigger: utils_1.createShorthand(Button_1.default, button, {
...
exports.SplitButton.Toggle = SplitButtonToggle_1.default;
 ...
 */
exports.default = types_1.withSafeTypeForAs(exports.SplitButton);
