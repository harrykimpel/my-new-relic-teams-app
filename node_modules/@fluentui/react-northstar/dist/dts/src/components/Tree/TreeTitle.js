...
var TreeTitle = function (props) {
    ...
    var _b = react_bindings_1.useStyles(TreeTitle.displayName, {
    ...
    var selectIndicator = Box_1.default.create(selectionIndicator, {
