...
var Slider = function (props) {
    ...
    var inputElement = Box_1.default.create(input || type, {
        defaultProps: function () {
            return getA11Props('input', tslib_1.__assign(tslib_1.__assign({}, htmlInputProps), { as: 'input', className: exports.sliderSlotClassNames.input, fluid: fluid, min: numericMin, max: numericMax, step: step, styles: resolvedStyles.input, type: type, value: numericValue, vertical: vertical }));
        },
