...
exports.CarouselNavigation = function (props) {
    ...
    var element = (React.createElement(ElementType, tslib_1.__assign({}, getA11yProps('root', tslib_1.__assign({ className: classes.root }, unhandledProps)), utils_1.rtlTextContainer.getAttributes({ forElements: [children] })), utils_1.childrenExist(children) ? children : renderItems()));
    setEnd();
    return element;
};
 ...
 */
exports.default = types_1.withSafeTypeForAs(exports.CarouselNavigation);
