...
import { WithAsProp, ShorthandCollection, ComponentEventHandler, FluentComponentStaticProps } from '../../types';
...
export declare const CarouselNavigation: React.FC<WithAsProp<CarouselNavigationProps>> & FluentComponentStaticProps<CarouselNavigationProps>;
