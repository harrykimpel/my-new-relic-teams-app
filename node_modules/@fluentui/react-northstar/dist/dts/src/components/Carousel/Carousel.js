...
exports.Carousel = function (props) {
    ...
    var itemRefs = React.useMemo(function () { var _a; return Array.from({ length: (_a = items) === null || _a === void 0 ? void 0 : _a.length }, function () { return React.createRef(); }); }, [(_a = items) === null || _a === void 0 ? void 0 : _a.length]);
    ...
    var focusItemAtIndex = _.debounce(function (index) {
        var _a;
        ...
        return (React.createElement("div", tslib_1.__assign({}, getA11yProps('itemsContainerWrapper', {
            ...
            React.createElement("div", tslib_1.__assign({}, getA11yProps('itemsContainer', {
                ...
                items.map(function (item, index) {
                    ...
                    return (React.createElement(Animation_1.default, { key: item['key'] || index, mountOnEnter: true, unmountOnExit: true, visible: active, name: initialMounting || !active
                            ? ''
                            : slideToNext
    ...
    var renderPaddles = function () {
        return (React.createElement(React.Fragment, null,
            React.createElement(react_component_ref_1.Ref, { innerRef: paddlePreviousRef }, CarouselPaddle_1.default.create(paddlePrevious, {
            ...
            React.createElement(react_component_ref_1.Ref, { innerRef: paddleNextRef }, CarouselPaddle_1.default.create(paddleNext, {
                defaultProps: function () {
    ...
    var renderNavigation = function () {
        ...
        })) : getItemPositionText ? (React.createElement(Text_1.default, { "aria-hidden": "true", className: exports.carouselSlotClassNames.pagination, content: getItemPositionText(+activeIndex, items.length) })) : null;
    };
...
exports.Carousel.Item = CarouselItem_1.default;
exports.Carousel.Navigation = CarouselNavigation_1.default;
exports.Carousel.NavigationItem = CarouselNavigationItem_1.default;
exports.Carousel.Paddle = CarouselPaddle_1.default;
 ...
 */
exports.default = types_1.withSafeTypeForAs(exports.Carousel);
