...
var treeTitleStyles = {
    root: function (_a) {
        ...
        return (tslib_1.__assign(tslib_1.__assign({ padding: v.padding, cursor: 'pointer', color: v.color, position: 'relative' }, (p.selectable && {
            ...
            alignItems: 'center',
        })), getBorderFocusStyles_1.default({ variables: siteVariables })));
    },
    selectionIndicator: function (_a) {
        var p = _a.props, v = _a.variables;
        return (tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({ display: 'inline-block', float: 'right', verticalAlign: 'middle', boxShadow: 'unset', width: utils_1.pxToRem(16), height: utils_1.pxToRem(16), borderColor: v.borderColor, borderStyle: v.borderStyle, borderRadius: v.borderRadius, borderWidth: v.borderWidth, color: v.indicatorColor, margin: v.selectionIndicatorMargin, padding: v.padding, userSelect: 'none', backgroundImage: checkboxIndicatorUrl_1.default(v.indicatorColor, v.background), backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }, (p.selected && {
            ...
            borderColor: v.checkedBorderColor,
            backgroundImage: checkboxIndicatorIndeterminatedUrl_1.default(v.checkedIndicatorColor, v.checkedBackground),
        })), (p.disabled && {
...
exports.default = treeTitleStyles;
