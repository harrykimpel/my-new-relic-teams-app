...
var svgIconStyles = {
    ...
    svg: function (_a) {
        var _b = _a.props, size = _b.size, disabled = _b.disabled, rotate = _b.rotate, v = _a.variables;
        var iconSizeInRems = getIconSize(size, v);
        return tslib_1.__assign(tslib_1.__assign({ display: 'block', width: iconSizeInRems, height: iconSizeInRems, fill: v.color || 'currentColor' }, (disabled && {
            fill: v.disabledColor,
        })), { transform: "rotate(" + rotate + "deg)" });
    },
    svgFlippingInRtl: function (config) {
        var props = config.props, rtl = config.rtl;
        return tslib_1.__assign(tslib_1.__assign({}, styles_1.callable(svgIconStyles.svg)(config)), (rtl && {
