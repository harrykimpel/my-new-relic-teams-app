...
var attachmentActionStyles = {
    root: function (_a) {
        ...
        return tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({ height: v.actionHeight, maxWidth: v.actionMaxWidth, display: 'inline-flex', justifyContent: 'center', alignItems: 'center', position: 'relative', verticalAlign: 'middle', cursor: 'pointer', 
            ...
            color: v.actionColor, backgroundColor: 'transparent', borderColor: 'transparent', padding: 0 }, getIconFillOrOutlineStyles_1.default({ outline: true })), { ':focus': tslib_1.__assign({ boxShadow: 'none' }, borderFocusStyles[':focus']), ':focus-visible': tslib_1.__assign(tslib_1.__assign({}, iconFilledStyles), borderFocusStyles[':focus-visible']) }), (p.primary && {
        ...
        })), { minWidth: v.actionHeight, ':hover': tslib_1.__assign({}, getIconFillOrOutlineStyles_1.default({ outline: false })) });
    },
    icon: function (_a) {
...
exports.default = attachmentActionStyles;
