...
exports.textColorAreas = utils_1.stringLiteralsArray('foreground');
exports.default = (function (siteVariables) {
    return {
        colorScheme: colorUtils_1.pickValuesFromColorScheme(siteVariables.colorScheme, exports.textColorAreas),
