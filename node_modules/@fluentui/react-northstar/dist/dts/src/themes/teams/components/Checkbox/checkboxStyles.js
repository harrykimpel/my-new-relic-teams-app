...
var checkboxStyles = {
    root: function (_a) {
        ...
        })), { cursor: 'pointer', outline: 0, color: v.textColor, padding: v.rootPadding, verticalAlign: 'middle', alignItems: 'start' }), getBorderFocusStyles_1.default({ variables: t.siteVariables, borderRadius: '3px' })), { ':hover': (_b = {
