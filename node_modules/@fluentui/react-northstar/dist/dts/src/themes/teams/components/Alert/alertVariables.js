...
exports.default = (function (siteVars) {
    var minHeight = utils_1.pxToRem(28);
    return {
        borderStyle: 'solid',
        borderWidth: '1px',
        ...
        minHeight: minHeight,
        padding: "0 " + utils_1.pxToRem(16),
        actionsMargin: utils_1.pxToRem(5),
        ...
        dismissiblePadding: "0 0 0 " + utils_1.pxToRem(16),
        ...
        headerMargin: "0 " + utils_1.pxToRem(10) + " 0 0",
        iconMargin: "0 " + utils_1.pxToRem(10) + " 0 0",
        ...
        dismissActionIndicatorSize: utils_1.pxToRem(16),
