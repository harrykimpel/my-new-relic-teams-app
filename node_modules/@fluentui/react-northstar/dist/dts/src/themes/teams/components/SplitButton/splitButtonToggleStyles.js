...
var getIndicatorStyles = function (color, outline, size) {
    return {
        ...
        width: size,
        height: size,
        backgroundImage: toggleIndicatorUrl_1.default(color, outline),
...
exports.default = splitButtonToggleStyles;
