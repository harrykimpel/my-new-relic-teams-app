...
var carouselNavigationItemStyles = {
    root: function (_a) {
        ...
        return tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({ color: 'inherit', display: 'block', cursor: 'pointer', whiteSpace: 'nowrap' }, (iconOnly && {
            ...
            // focus styles
            ':focus-visible': tslib_1.__assign({}, (iconOnly && tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({ borderRadius: '50%' }, (thumbnails && { borderRadius: '0' })), { borderColor: v.iconOnlyColorActive }), getIconFillOrOutlineStyles_1.default({ outline: false })))) }), (iconOnly &&
            primary && {
            color: 'inherit',
