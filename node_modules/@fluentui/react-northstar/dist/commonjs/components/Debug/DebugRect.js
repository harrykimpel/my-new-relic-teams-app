...
function (_React$Component) {
  (0, _inherits2.default)(DebugRect, _React$Component);
  ...
  function DebugRect() {
    ...
    (0, _classCallCheck2.default)(this, DebugRect);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf2 = (0, _getPrototypeOf3.default)(DebugRect)).call.apply(_getPrototypeOf2, [this].concat(args)));
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "selectorRef", React.createRef());
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "setDebugSelectorPosition", function () {
  ...
  (0, _createClass2.default)(DebugRect, [{
