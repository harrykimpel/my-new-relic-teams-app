...
exports.default = exports.buttonClassName = void 0;
...
var Button = (0, _reactBindings.compose)(function (props, ref, composeOptions) {
  ...
  var result = React.createElement(ElementType, (0, _extends2.default)({}, _utils.rtlTextContainer.getAttributes({
    ...
    onFocus: handleFocus,
    ref: ref
  }, unhandledProps))), hasChildren ? children : React.createElement(React.Fragment, null, loading && renderLoader(), iconPosition !== 'after' && renderIcon(), renderContent(), iconPosition === 'after' && renderIcon()));
  setEnd();
  return result;
}, {
  ...
  displayName: 'Button',
  slots: {
    content: _ButtonContent.default,
    icon: _Box.default,
    loader: _Loader.default
  },
  mapPropsToSlotProps: function mapPropsToSlotProps(props) {
    return {
      content: {
        size: props.size
      },
