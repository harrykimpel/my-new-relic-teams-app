...
exports.default = exports.SplitButton = exports.splitButtonClassName = void 0;
...
var _SplitButtonToggle = _interopRequireDefault(require("./SplitButtonToggle"));
...
var SplitButton = function SplitButton(props) {
  ...
  }, unhandledProps)), _MenuButton.default.create({}, {
    defaultProps: function defaultProps() {
      return getA11yProps('menuButton', {
        menu: menu,
        on: [],
        open: open,
        trigger: (0, _utils.createShorthand)(_Button.default, button, {
          defaultProps: function defaultProps() {
            return {
  ...
  }), _SplitButtonToggle.default.create(toggleButton, {
    defaultProps: function defaultProps() {
...
SplitButton.Toggle = _SplitButtonToggle.default;
