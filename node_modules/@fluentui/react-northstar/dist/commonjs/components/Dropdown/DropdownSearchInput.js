...
exports.default = exports.DropdownSearchInput = exports.dropdownSearchInputSlotClassNames = exports.dropdownSearchInputClassName = void 0;
...
var dropdownSearchInputSlotClassNames = {
  input: "".concat(dropdownSearchInputClassName, "__input"),
  wrapper: "".concat(dropdownSearchInputClassName, "__wrapper")
};
...
var DropdownSearchInput = function DropdownSearchInput(props) {
  ...
  var element = React.createElement(_Input.default, (0, _extends2.default)({
    disabled: disabled,
    inputRef: inputRef,
    onFocus: handleFocus,
    onKeyUp: handleKeyUp
