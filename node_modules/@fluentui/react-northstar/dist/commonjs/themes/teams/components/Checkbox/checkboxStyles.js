...
var checkboxStyles = {
  root: function root(_ref) {
    ...
    return Object.assign({
      ...
      gridTemplateColumns: "1fr ".concat(v.gap, " auto"),
      // IE11: Gap is done via virtual column as in autoprefixer
      msGridColumns: "auto ".concat(v.gap, " 1fr")
    }, p.labelPosition === 'start' && {
      gridTemplateColumns: "1fr ".concat(v.gap, " auto"),
      msGridColumns: "1fr ".concat(v.gap, " auto")
    }, {
      cursor: 'pointer',
      outline: 0,
      color: v.textColor,
      ...
      }, "& .".concat(_Checkbox.checkboxSlotClassNames.indicator), Object.assign({}, !p.toggle && Object.assign({}, p.checked && {
