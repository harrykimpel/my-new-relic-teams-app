...
exports.default = exports.toolbarColorAreas = void 0;
...
var _default = function _default(siteVars) {
  return {
    ...
    borderWidth: '2px',
    borderRadius: '50%',
    dividerMargin: "".concat((0, _utils.pxToRem)(10), " ").concat((0, _utils.pxToRem)(4)),
    menuWidth: (0, _utils.pxToRem)(200),
    menuPadding: "".concat((0, _utils.pxToRem)(8), " 0"),
    ...
    menuItemPadding: "".concat((0, _utils.pxToRem)(9), " ").concat((0, _utils.pxToRem)(16)),
    menuDividerBorder: undefined,
    menuDividerMargin: "".concat((0, _utils.pxToRem)(8), " 0"),
