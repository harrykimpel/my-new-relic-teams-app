...
var _default = function _default(siteVars) {
  ...
  return {
    ...
    minHeight: minHeight,
    padding: "0 ".concat((0, _utils.pxToRem)(16)),
    ...
    dismissiblePadding: "0 0 0 ".concat((0, _utils.pxToRem)(16)),
    ...
    headerMargin: "0 ".concat((0, _utils.pxToRem)(10), " 0 0"),
    iconMargin: "0 ".concat((0, _utils.pxToRem)(10), " 0 0"),
