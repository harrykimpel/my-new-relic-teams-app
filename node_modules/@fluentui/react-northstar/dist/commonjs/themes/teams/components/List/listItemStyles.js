...
var selectableHoverStyle = function selectableHoverStyle(p, v) {
  ...
  return _ref = {
    ...
    cursor: 'pointer'
  }, (0, _defineProperty2.default)(_ref, "& .".concat(_ListItem.listItemSlotClassNames.header), {
    color: 'inherit'
  }), (0, _defineProperty2.default)(_ref, "& .".concat(_ListItem.listItemSlotClassNames.content), {
    color: 'inherit'
  }), (0, _defineProperty2.default)(_ref, "& .".concat(_ListItem.listItemSlotClassNames.headerMedia), Object.assign({}, _accessibilityStyles.screenReaderContainerStyles, {
    color: 'inherit'
  })), (0, _defineProperty2.default)(_ref, "& .".concat(_ListItem.listItemSlotClassNames.contentMedia), {
    display: 'none',
    color: 'inherit'
  }), (0, _defineProperty2.default)(_ref, "& .".concat(_ListItem.listItemSlotClassNames.endMedia), {
    display: 'block',
    color: 'inherit'
  }), _ref;
};
...
var listItemStyles = {
  root: function root(_ref2) {
    ...
    return Object.assign({
      ...
      position: 'relative'
    }, (0, _defineProperty2.default)(_Object$assign, "& .".concat(_ListItem.listItemSlotClassNames.endMedia), {
      display: 'none'
