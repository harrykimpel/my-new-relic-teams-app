...
var getIconFillOrOutlineStyles = function getIconFillOrOutlineStyles(_ref) {
  ...
  return _ref2 = {}, (0, _defineProperty2.default)(_ref2, "& .".concat(_reactIconsNorthstar.iconClassNames.filled), {
    display: outline ? 'none' : 'block'
  }), (0, _defineProperty2.default)(_ref2, "& .".concat(_reactIconsNorthstar.iconClassNames.outline), {
    display: outline ? 'block' : 'none'
  }), _ref2;
};

var _default = getIconFillOrOutlineStyles;
