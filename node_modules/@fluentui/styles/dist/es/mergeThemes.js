...
export var mergeComponentStyles__PROD = function mergeComponentStyles__PROD() {
  ...
  return sources.reduce(function (partStylesPrepared, stylesByPart) {
    _forEach(stylesByPart, function (partStyle, partName) {
      ...
      if (typeof originalSource === 'undefined' || originalSource === null || _typeof(originalSource) === 'object' && Object.keys(originalSource).length === 0) {
        return;
    ...
    _forEach(stylesByPart, function (partStyle, partName) {
      ...
      if (typeof originalTarget === 'undefined') {
        partStylesPrepared[partName] = function (styleParam) {
          ...
          var _ref = callable(originalSource)(styleParam) || {},
              ...
              styles = _objectWithoutProperties(_ref, ["_debug"]); // new object required to prevent circular JSON structure error in <Debug />
      ...
      partStylesPrepared[partName] = function (styleParam) {
        ...
        var _originalTarget = originalTarget(styleParam),
            ...
            targetStyles = _objectWithoutProperties(_originalTarget, ["_debug"]);
        ...
        var _ref2 = callable(originalSource)(styleParam) || {},
            ...
            sourceStyles = _objectWithoutProperties(_ref2, ["_debug"]);
  ...
  return sources.reduce(function (acc, next) {
    return function (siteVariables) {
      var _acc = acc(siteVariables),
          ...
          accumulatedVariables = _objectWithoutProperties(_acc, ["_debug"]);
      ...
      var _ref3 = callable(next)(siteVariables) || {},
          ...
          computedComponentVariables = _objectWithoutProperties(_ref3, ["_debug", "_debugId"]);
...
export var mergeSiteVariables__DEV = function mergeSiteVariables__DEV() {
  ...
  return sources.reduce(function (acc, next) {
    var _acc$_debug2 = acc._debug,
        ...
        accumulatedSiteVariables = _objectWithoutProperties(acc, ["_debug"]);
    ...
    var _ref4 = next || {},
        ...
        nextSiteVariables = _objectWithoutProperties(_ref4, ["_debug", "_invertedKeys", "_debugId"]);
...
export var mergeThemeVariables__PROD = function mergeThemeVariables__PROD() {
  ...
  return displayNames.reduce(function (componentVariables, displayName) {
    componentVariables[displayName] = mergeComponentVariables.apply(void 0, _toConsumableArray(_map(sources, displayName)));
...
export var mergeThemeVariables__DEV = function mergeThemeVariables__DEV() {
  ...
  return displayNames.reduce(function (componentVariables, displayName) {
    componentVariables[displayName] = mergeComponentVariables.apply(void 0, _toConsumableArray(_map(sources, function (source) {
