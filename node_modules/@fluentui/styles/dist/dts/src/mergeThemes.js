    ...
    return sources.reduce(function (partStylesPrepared, stylesByPart) {
        _.forEach(stylesByPart, function (partStyle, partName) {
            ...
            if (typeof originalTarget === 'undefined') {
                partStylesPrepared[partName] = callable_1.default(originalSource);
                return;
            }
            ...
            partStylesPrepared[partName] = function (styleParam) {
                ...
                return _.merge(originalTarget(styleParam), callable_1.default(originalSource)(styleParam));
            };
        });
        ...
        _.forEach(stylesByPart, function (partStyle, partName) {
            ...
            if (typeof originalTarget === 'undefined') {
                partStylesPrepared[partName] = function (styleParam) {
                    ...
                    var _a = callable_1.default(originalSource)(styleParam) || {}, _b = _a._debug, _debug = _b === void 0 ? undefined : _b, styles = tslib_1.__rest(_a, ["_debug"]);
            ...
            partStylesPrepared[partName] = function (styleParam) {
                ...
                var _b = callable_1.default(originalSource)(styleParam) || {}, _c = _b._debug, sourceDebug = _c === void 0 ? undefined : _c, sourceStyles = tslib_1.__rest(_b, ["_debug"]);
...
exports.mergeComponentVariables__PROD = function () {
    ...
    return sources.reduce(function (acc, next) {
        return function () {
            ...
            var computedComponentVariables = callable_1.default(next).apply(void 0, args);
            return deepmerge_1.default(accumulatedVariables, computedComponentVariables);
        };
    }, initial);
};
exports.mergeComponentVariables__DEV = function () {
    ...
    return sources.reduce(function (acc, next) {
        return function (siteVariables) {
            ...
            var _c = callable_1.default(next)(siteVariables) || {}, _d = _c._debug, computedDebug = _d === void 0 ? undefined : _d, _e = _c._debugId, _debugId = _e === void 0 ? undefined : _e, computedComponentVariables = tslib_1.__rest(_c, ["_debug", "_debugId"]);
            var merged = deepmerge_1.default(accumulatedVariables, computedComponentVariables);
...
exports.mergeSiteVariables__PROD = function () {
    ...
    return deepmerge_1.default.apply(void 0, tslib_1.__spreadArrays([initial], sources));
};
exports.mergeSiteVariables__DEV = function () {
    ...
    return sources.reduce(function (acc, next) {
        ...
        var merged = deepmerge_1.default(tslib_1.__assign(tslib_1.__assign({}, accumulatedSiteVariables), { _invertedKeys: undefined }), nextSiteVariables);
        merged._debug = _debug.concat(computedDebug || { resolved: nextSiteVariables, debugId: _debugId });
        merged._invertedKeys = _invertedKeys || objectKeysToValues_1.default(merged, function (key) { return "siteVariables." + key; });
        return merged;
    }, initial);
};
...
exports.mergeThemeVariables__DEV = function () {
    ...
    var displayNames = _.union.apply(_, _.map(sources, _.keys));
    return displayNames.reduce(function (componentVariables, displayName) {
        componentVariables[displayName] = exports.mergeComponentVariables.apply(void 0, _.map(sources, function (source) { return source && withDebugId_1.default(source[displayName], source._debugId); }));
        return componentVariables;
    }, {});
};
...
exports.mergeThemeStyles = function () {
    ...
    return sources.reduce(function (themeComponentStyles, next) {
        _.forEach(next, function (stylesByPart, displayName) {
            themeComponentStyles[displayName] = exports.mergeComponentStyles(themeComponentStyles[displayName], withDebugId_1.default(stylesByPart, next._debugId));
        });
...
exports.mergeFontFaces = function () {
    ...
    return toCompactArray_1.default.apply(void 0, sources);
};
...
exports.mergeStyles = function () {
    ...
    return function () {
        ...
        return sources.reduce(function (acc, next) {
            return _.merge(acc, callable_1.default(next).apply(void 0, args));
        }, {});
    };
};
var mergeThemes = function () {
    ...
    return themes.reduce(function (acc, next) {
        ...
        acc.siteVariables = exports.mergeSiteVariables(acc.siteVariables, withDebugId_1.default(next.siteVariables, nextDebugId));
        acc.componentVariables = exports.mergeThemeVariables(acc.componentVariables, withDebugId_1.default(next.componentVariables, nextDebugId));
