...
var NestingRoot = /** @class */ (function (_super) {
    ...
    function NestingRoot() {
        ...
        _this.registry = new RefStack_1.default();
    ...
    NestingRoot.prototype.render = function () {
        return (React.createElement(NestingContext_1.default.Provider, { value: this.registry }, this.props.children(this.getRefs, this.parentRef)));
    };
    return NestingRoot;
}(React.Component));
exports.default = NestingRoot;
