 ...
 */
var gridNestedBehavior = function (props) { return ({
    attributes: {
        root: {
            role: 'grid',
        },
    ...
    focusZone: {
        props: {
            shouldEnterInnerZone: function (event) { return keyboardKey.getCode(event) === keyboardKey.ArrowRight; },
    ...
    childBehaviors: {
        row: gridRowBehavior_1.default,
    },
}); };
exports.default = gridNestedBehavior;
