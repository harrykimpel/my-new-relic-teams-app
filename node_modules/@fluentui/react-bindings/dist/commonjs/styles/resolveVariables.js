...
var resolveVariables = function resolveVariables(displayNames, theme, variables, enabledVariablesCaching) {
  ...
  if (enabledVariablesCaching) {
    ...
    if (!variablesThemeCache[handlingDisplayName]) {
      variablesThemeCache[handlingDisplayName] = _styles.mergeComponentVariables.apply(void 0, (0, _toConsumableArray2.default)(effectiveDisplayNames.map(function (displayName) {
        return theme.componentVariables[displayName];
      })))(theme.siteVariables);
    ...
    componentThemeVariables = _styles.mergeComponentVariables.apply(void 0, (0, _toConsumableArray2.default)(effectiveDisplayNames.map(function (displayName) {
      return theme.componentVariables[displayName];
    })))(theme.siteVariables);
  }
