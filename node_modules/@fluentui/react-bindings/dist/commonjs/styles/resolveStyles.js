...
var resolveStyles = function resolveStyles(options, resolvedVariables, renderStylesInput) {
  ...
  if (displayNames.length === 1) {
    ...
    if (_styles.length > 0) {
      mergedStyles = _styles2.mergeComponentStyles.apply(void 0, (0, _toConsumableArray2.default)(_styles));
    } else {
      mergedStyles = {
        root: function root() {
          return {};
  ...
  if (!noInlineStylesOverrides) {
    mergedStyles = (0, _styles2.mergeComponentStyles)(mergedStyles, props.design && (0, _styles2.withDebugId)({
      root: props.design
    }, 'props.design'), props.styles && (0, _styles2.withDebugId)({
      root: props.styles
    }, 'props.styles'));
  }
