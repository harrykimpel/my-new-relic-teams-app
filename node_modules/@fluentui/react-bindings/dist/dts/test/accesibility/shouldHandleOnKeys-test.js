...
describe('shouldHandleOnKeys', function () {
    test('should return `true`', function () {
        ...
        var events = tslib_1.__spreadArrays(keyCombinations, [
        ...
        events.forEach(function (event) {
            expect(shouldHandleOnKeys_1.default(event, keyCombinations)).toBe(true);
        });
    });
    test('should return `false`', function () {
        ...
        events.forEach(function (event) {
            expect(shouldHandleOnKeys_1.default(event, keyCombinations)).toBe(false);
        });
    });
});
