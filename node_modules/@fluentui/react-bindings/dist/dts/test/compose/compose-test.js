...
var BaseComponent = react_bindings_1.compose(function (props, ref, composeOptions) {
    ...
    // @ts-ignore
    return React.createElement("button", tslib_1.__assign({ className: classes.root, onClick: function () { return setOpen(!open); } }, unhandledProps, { ref: ref }));
}, {
    className: 'ui-base',
...
var BaseComponentWithSlots = react_bindings_1.compose(function (props, ref, composeOptions) {
    ...
    return (
    // @ts-ignore
    React.createElement("button", tslib_1.__assign({ className: classes.root }, unhandledProps, { ref: ref }),
    ...
    mapPropsToSlotProps: function (props) { return ({
        start: {
