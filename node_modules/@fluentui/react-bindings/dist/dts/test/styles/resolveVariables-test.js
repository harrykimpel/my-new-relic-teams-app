...
describe('resolveVariables', function () {
    test('resolved variables', function () {
        var variables = resolveVariables_1.default(['Test'], createTheme(), {}, false);
    ...
    test('merges theme with input variables', function () {
        ...
        var variables = resolveVariables_1.default(['Test'], createTheme(), propsVariables, false);
    ...
    test('avoids merging if variables are undefined', function () {
        ...
        var variables = resolveVariables_1.default(['Test'], theme, undefined, false);
        expect(variables).toMatchObject({ backgroundColor: 'blue' });
    });
    test('avoids merging for multiple display names if variables are undefined', function () {
        ...
        var variables = resolveVariables_1.default(['Foo', 'Bar'], theme, undefined, false);
        expect(variables).toMatchObject({ backgroundColor: 'blue' });
    });
    describe('enabledVariablesCaching', function () {
        test('caches resolved variables', function () {
            ...
            var variables = resolveVariables_1.default(['Foo'], theme, {}, true);
            var secondVariables = resolveVariables_1.default(['Foo'], theme, {}, true);
        ...
        test('omits usage of undefined variables', function () {
            ...
            expect(resolveVariables_1.default(['Foo', 'Bar'], theme, {}, true)).toMatchObject({ content: 'foo' });
            expect(fooVariables).toHaveBeenCalledTimes(1);
        });
        test('handles multiple displayNames', function () {
            ...
            expect(resolveVariables_1.default(['Foo', 'Bar'], theme, {}, true)).toMatchObject({
                backgroundColor: 'green',
                borderColor: 'black',
                color: 'red',
            });
            // Runs to check cache
            _.times(3, function () { return resolveVariables_1.default(['Foo', 'Bar'], theme, {}, true); });
            expect(fooVariables).toHaveBeenCalledTimes(1);
        ...
        test('considers displayName while caching resolved variables', function () {
            ...
            var theme = createTheme({ Foo: fooVariables, Bar: barVariables });
            var variables = resolveVariables_1.default(['Foo'], theme, {}, true);
            var secondVariables = resolveVariables_1.default(['Bar'], theme, {}, true);
            expect(variables).toMatchObject({ backgroundColor: 'blue' });
        ...
        test('considers theme while caching resolved variables', function () {
            ...
            var variables = resolveVariables_1.default(['Foo'], theme, {}, true);
            var secondVariables = resolveVariables_1.default(['Foo'], secondTheme, {}, true);
            expect(variables).toMatchObject({ backgroundColor: 'blue' });
