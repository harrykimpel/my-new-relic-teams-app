...
var rtlKeyMap = (_a = {},
    _a[keyboardKey.ArrowRight] = keyboardKey.ArrowLeft,
    _a[keyboardKey.ArrowLeft] = keyboardKey.ArrowRight,
    _a);
/**
                ...
                onKeyDown: function (event) {
                    handledActions.forEach(function (actionName) {
                        ...
                        if (keyCombinations) {
                            ...
                            if (shouldHandleOnKeys_1.default(event, keyCombinations)) {
...
exports.default = getKeyDownHandlers;
